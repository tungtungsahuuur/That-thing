local function LoadAdvancedConsole()
    ...
    function AdvancedConsole:_initialize()
        ...
        -- Initial messages
        self:Log("Console initialized successfully")
        self:Info("System ready for messages")
        self:Success("All components loaded")
        self:Warn("No commands registered yet - use :RegisterCommand()")
    end
    ...
    function AdvancedConsole:_createMessageContainer()
        ...
        self._messageContainer.ScrollBarImageColor极
    ...
    function AdvancedConsole:_createCommandBox()
        ...
        prompt.Size = UDim2.new(0, 20, 1, 极
        ...
        inputContainer.Position = UDim2.new(0, 25, 极
        ...
        self._commandInput.TextColor3 = Color3.from极
    ...
    function AdvancedConsole:RegisterCommand(name, callback)
        ...
        self:Success("Command '" .. commandName .. "' registered successfully")
        return true
    end
    ...
    if not success then
        -- If console creation fails, create a minimal error handler
